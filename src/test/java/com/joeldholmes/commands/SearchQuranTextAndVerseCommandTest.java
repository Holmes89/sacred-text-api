...
public class SearchQuranTextAndVerseCommandTest {

	@Mock
	SearchService searchService;
	
	@InjectMocks
	private SearchQuranTextAndVerseCommand cmd = new SearchQuranTextAndVerseCommand();
	...
	public void testCommand() throws ServiceException{
		...
		Mockito.when(searchService.searchQuranVerseAndText(Mockito.anyString())).thenReturn(dtos);
	...
	public void testException() throws ServiceException{
		...
		Mockito.when(searchService.searchQuranVerseAndText(Mockito.anyString())).thenThrow(new ServiceException(ErrorCodes.NULL_INPUT, "Chapter cannot be null"));
