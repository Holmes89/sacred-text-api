...
public class SearchAllTextCommandTest {

	@Mock
	SearchService searchService;
	
	@InjectMocks
	private SearchAllTextCommand cmd = new SearchAllTextCommand();
	...
	public void testCommand() throws ServiceException{
		...
		Mockito.when(searchService.searchAllText(Mockito.anyString())).thenReturn(dtos);
	...
	public void testException() throws ServiceException{
		...
		Mockito.when(searchService.searchAllText(Mockito.anyString())).thenThrow(new ServiceException(ErrorCodes.NULL_INPUT, "Chapter cannot be null"));
