...
public class SearchTaoTextCommandTest {

	@Mock
	SearchService searchService;
	
	@InjectMocks
	private SearchTaoTextCommand cmd = new SearchTaoTextCommand();
	...
	public void testCommand() throws ServiceException{
		...
		Mockito.when(searchService.searchTaoText(Mockito.anyString())).thenReturn(dtos);
	...
	public void testException() throws ServiceException{
		...
		Mockito.when(searchService.searchTaoText(Mockito.anyString())).thenThrow(new ServiceException(ErrorCodes.NULL_INPUT, "Chapter cannot be null"));
