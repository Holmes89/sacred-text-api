...
public class SearchAllTextAndVerseCommandTest {

	@Mock
	SearchService searchService;
	
	@InjectMocks
	private SearchAllTextAndVerseCommand cmd = new SearchAllTextAndVerseCommand();
	...
	public void testCommand() throws ServiceException{
		...
		Mockito.when(searchService.searchAllVerseAndText(Mockito.anyString())).thenReturn(dtos);
	...
	public void testException() throws ServiceException{
		...
		Mockito.when(searchService.searchAllVerseAndText(Mockito.anyString())).thenThrow(new ServiceException(ErrorCodes.NULL_INPUT, "Chapter cannot be null"));
