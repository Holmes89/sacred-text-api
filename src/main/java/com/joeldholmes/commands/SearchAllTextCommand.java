...
@Component
@Scope("prototype")
public class SearchAllTextCommand extends BaseCommand<List<VerseDTO>> {
	...
	protected SearchAllTextCommand() {
		super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("SacredTextAPI"))
				.andCommandKey(HystrixCommandKey.Factory.asKey("SearchAllText")));
	}
	
	
	public SearchAllTextCommand setTerm(String term){
		this.term=term;
		return this;
	}
	...
	protected List<VerseDTO> run() throws Exception {
		try{
			return searchService.searchAllText(term);
		}
