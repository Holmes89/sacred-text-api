...
@Component
@Scope("prototype")
public class SearchTaoTextCommand extends BaseCommand<List<VerseDTO>> {
	...
	protected SearchTaoTextCommand() {
		super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("SacredTextAPI"))
				.andCommandKey(HystrixCommandKey.Factory.asKey("SearchTaoText")));
	}
	
	
	public SearchTaoTextCommand setTerm(String term){
		this.term=term;
		return this;
	}
	...
	protected List<VerseDTO> run() throws Exception {
		try{
			return searchService.searchTaoText(term);
		}
